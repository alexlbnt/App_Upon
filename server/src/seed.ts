...
import { Establishment } from './modules/establishments/establishment.entity';
...
const AppDataSource = new DataSource({
  ...
  password: '123',
  database: 'upon_db',
  entities: [User, Category, Establishment, Coupon],
  synchronize: true, // Cria as tabelas antes de inserir
});
...
async function runSeed() {
  try {
    ...
    // 1. Clear existing data (reverse order of relationships)
